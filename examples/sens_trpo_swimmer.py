    ...
    for learning_rate in learning_rates:
        for bas in baselines:
            ...
            run_experiment_lite(
                ...
                exp_prefix='trpo_sensitive_swimmer_2017_02_10_1d',
                exp_name='bignet_sens'+str(int(use_sensitive))+'_fbs'+str(fast_batch_size)+'_mbs'+str(meta_batch_size)+'_flr_' + str(fast_learning_rate) + '_lr_' + str(learning_rate) + 'baseline_' + bas +'_step1'+str(num_grad_updates) + '_oracle' + str(int(oracle)),
                plot=False,
            )
