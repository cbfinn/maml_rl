...
# pre-ICML
file1 = 'data/s3/happybugfix-trpo-sensitive-ant200/_sens1_fbs20_mbs40_flr_0.1_mlr0.01/itr_575.pkl'
...
# post-ICML (after modifying vel range)
file1 = 'data/s3/posticml-trpo-sensitive-ant200/sens1_fbs20_mbs40_flr_0.1_mlr0.01/itr_375.pkl'
file2 = 'data/s3/posticml-trpo-sensitive-ant200/randenv100traj/itr_575.pkl'
file3 = 'data/s3/posticml-trpo-sensitive-ant200/oracleenv100traj/itr_550.pkl'
