...
This repo contains code accompaning the paper, 	[Model-Agnostic Meta-Learning for Fast Adaptation of Deep Networks (Finn et al., ICML 2017)](https://arxiv.org/abs/1703.03400). It includes code for running the few-shot reinforcement learning experiments. For the experiments from the supervised domain, see [this codebase](https://github.com/cbfinn/maml).

Coming soon! (within 24 hours of 7/18/2017)


This code is based off of the rllab code repository:
